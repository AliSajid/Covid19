...
a5491 <- sapply(cutoffs, process_seed_groups, groups = all_groups, names = names, signature_map = maps[[sig_map_names[1]]], cell_line = sig_map_names[1])

a5492 <- sapply(cutoffs, process_seed_groups, groups = all_groups, names = names, signature_map = maps[[sig_map_names[2]]], cell_line = sig_map_names[2])

ha1e2 <- sapply(cutoffs, process_seed_groups, groups = all_groups, names = names, signature_map = maps[[sig_map_names[3]]], cell_line = sig_map_names[3])

ht29 <- sapply(cutoffs, process_seed_groups, groups = all_groups, names = names, signature_map = maps[[sig_map_names[4]]], cell_line = sig_map_names[4])

mcf72 <- sapply(cutoffs, process_seed_groups, groups = all_groups, names = names, signature_map = maps[[sig_map_names[5]]], cell_line = sig_map_names[5])

pc3 <- sapply(cutoffs, process_seed_groups, groups = all_groups, names = names, signature_map = maps[[sig_map_names[6]]], cell_line = sig_map_names[6])

vcap1 <- sapply(cutoffs, process_seed_groups, groups = all_groups, names = names, signature_map = maps[[sig_map_names[7]]], cell_line = sig_map_names[7])

vcap2 <- sapply(cutoffs, process_seed_groups, groups = all_groups, names = names, signature_map = maps[[sig_map_names[8]]], cell_line = sig_map_names[8])
